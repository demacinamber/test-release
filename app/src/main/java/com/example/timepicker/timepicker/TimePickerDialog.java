...
public class TimePickerDialog extends AlertDialog implements OnClickListener,
    ...
    public void show() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getButton(BUTTON_POSITIVE).setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(getContext(), R.color.orange)));
        }
    ...
    protected void onStart() {
       ...
       /* int width = (int) (getContext().getResources().getDisplayMetrics().widthPixels * 0.0);
